...
const EmailUploader = () => {
  ...
  return (
    <div style={{ minHeight: '100vh', width: '100%', boxSizing: 'border-box', background: '#f9fafb', overflowY: 'auto' }}>
      <NavBar />
      <div  style={{
        padding: '24px',
        ...
        width: '100%',
        margin: '0 auto',
        marginTop: '150px', // Increased top margin for more gap below navbar
      }}>
        <h2 style={{
          fontSize: '20px',
          fontWeight: '600',
